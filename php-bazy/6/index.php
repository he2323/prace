...
//create user
$dbname = "dbnowa";
$sql = "CREATE USER wdbnowa IDENTIFIED BY 'wdbnowa123';GRANT ALL PRIVILEGES ON *.* TO 'wdbnowa'@'%' WITH GRANT OPTION;ALTER USER 'wdbnowa'@'%' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;GRANT ALL PRIVILEGES ON `wdbnowa`.* TO 'dbnowa'@'%';";
